...
public class RestExceptionHandler {
    ...
    /**
     * Método para lançar uma mensagem de erro personalizada, quando o usuario requisitar um dado não existente
     * @param ex Parametro da expection disparada
     * @return uma mensagem de erro not found
     */
    ...
    /**
     *  Método para lançar uma mensagem de erro personalizada, quando o usuario, fornecer informações erradas ou incompletas nos
     *   campos da requisição.
      * @param e Parametro da expection disparada
     * @return uma mensagem de erro bad request
     */
